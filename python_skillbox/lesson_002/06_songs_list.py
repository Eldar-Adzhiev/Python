...
print("Три песни звучат", time_halo + time_Enjoy_the_Silence + time_Clean, "минут")
...
time_Sweetest_Perfection = violator_songs_dict['Sweetest Perfection']
time_Policy_of_Truth = violator_songs_dict['Policy of Truth']
time_Blue_Dress = violator_songs_dict['Blue Dress']
...
print('А другие три песни звучат', sum_sound_time, 'минут')
