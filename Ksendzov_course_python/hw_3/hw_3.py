...
if mult_int > comp_item:
    print("Перменная mult_int больше", comp_item)

div_int = int_item/2
if div_int < comp_item:
    print("Перменная div_int меньше", comp_item)

item_1 = int_item + 10
if item_1 < comp_item:
    print("Переменная item_1 меньше", comp_item)
else:
    print("Переменная iten_1 больще или равна", comp_item)
...
if item_5:
    ...
    print('Переменная item_3 =', item_4)

if item_4:
    print("Переменная item_3 = ", item_5)
else:
    print('Переменная item_3 =', item_4)
